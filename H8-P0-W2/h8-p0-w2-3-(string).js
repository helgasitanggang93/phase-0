...
if(word!=='' && second!=='' && third!=='' && fourth!=='' && fifth!=='' && sixth!=='' && seventh!==''){
...
var exampleFirstWord2 = word2[0] + word2[1] + word2[2] + word2[3];
var secondWord2 = word2[4] + word2[5] + word2[6] + word2[7] + word2[8] + word2[9] + word2[10] + word2[11] + word2[12] + word2[13] + word2[14]; // do your own!
var thirdWord2 = word2[15] + word2[16] + word2[17]; // do your own!
var fourthWord2 = word2[18] + word2[19] + word2[20]; // do your own!
var fifthWord2 = word2[21] + word2[22] + word2[23] + word2[24]; // do your own!

console.log('First Word2: ' + exampleFirstWord2);
console.log('Second Word2: ' + secondWord2);
console.log('Third Word2: ' + thirdWord2);
console.log('Fourth Word2: ' + fourthWord2);
console.log('Fifth Word2: ' + fifthWord2);
...
console.log('Fourth Word4: ' + fourthWord4 + ', with length:' + fourthWordLength);
